...
contains
  ...
  subroutine test_ad
    ...
    call assert_equals( "test_ad", 0.0_wp, c_tl * c_ad - fp( n, a_tl, a_ad ) - dot_product( b_tl, b_ad ), EPS )
...
end module cost_mod_test
  
  
!> @brief Runs the testsuite.
program main
  use cost_mod_test, only: run_testsuite
