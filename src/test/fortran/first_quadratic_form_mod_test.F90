...
module first_quadratic_form_mod_test
  use first_quadratic_form_mod
  use test_mod
  use math_mod
...
end module first_quadratic_form_mod_test
  
  
!> @brief Runs the testsuite.
program main
  use first_quadratic_form_mod_test, only: run_testsuite
